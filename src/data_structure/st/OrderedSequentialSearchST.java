...
//		OrderedSequentialSearchST<Double,Integer> data_structure.st = new OrderedSequentialSearchST<>();
//		for(int i = 0;i<20;i++){
//			data_structure.st.put((double)i, i);
//		}
//		for(int i = 0;i<data_structure.st.size() + 1;i++){
//			System.out.println(data_structure.st.rank((double)i));
//			System.out.println(data_structure.st.rank(data_structure.st.select(i)));
//		}
//	}
}
